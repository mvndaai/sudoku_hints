...
// These are default groups for a standard Sudoku game.
// There are always the same number of groups as there are symbols.

var DefaultGroup9x9 = map[Loc]int{
...
var DefaultGroup4x4 = map[Loc]int{
